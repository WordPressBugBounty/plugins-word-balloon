...
function word_balloon_build_word_balloon_box( $atts , $content ){
	...
	if( file_exists( WORD_BALLOON_DIR . 'inc/adjust/adjust_'.basename($atts['balloon']).'.php' ) ){
		require_once WORD_BALLOON_DIR . 'inc/adjust/adjust_'.basename($atts['balloon']).'.php';
	}
    ...
    */
	...
	$msg .= '<div class="w_b_wrap w_b_wrap_'.$atts['balloon'].' w_b_'.$atts['position'].' w_b_flex'.$w_b_class['w_b_wrap'].' w_b_div" style="'.esc_attr($w_b_style['w_b_wrap']).'">';
